...
d.data1 <- filter(d.data, Q59_Travel_abroad >2 & Q53_Gender == 2)
detach(d.data)
...
q18.plot <- ggplot(q18.melt, aes(x=Attitude, y=RelFreq)) + 
  ...
  labs(x="\nEven if parents' demands are unreasonable,\nchildren should still do what they ask.",
       y="Relative frequency", title="Figure 4.8a: Relative frequency distribution for\nTraditionalism Battery, item A, female respondents only")
q18.plot 
...
q19.plot <- ggplot(q19.melt, aes(x=Attitude, y=RelFreq)) + 
  ...
  labs(x="\nBeing a student,\none should not question the authority of their teacher.",
       y="Relative frequency", title="Figure 4.9a: Relative frequency distribution for\nTraditionalism Battery, item B, female respondents only")
q19.plot
...
q20.plot <- ggplot(q20.melt, aes(x=Attitude, y=RelFreq)) + 
  ...
  labs(x="\nWhen one has a conflict with a neighbor,\nthe best way to deal with it is to yield to the other person.",
       y="Relative frequency", title="Figure 4.10a: Relative frequency distribution for\nTraditionalism Battery, item C, female respondents only")
q20.plot
...
q21.plot <- ggplot(q21.melt, aes(x=Attitude, y=RelFreq)) + 
  ...
  labs(x="\nFor the sake of the family,\nthe individual should put his personal interests second.",
       y="Relative frequency", title="Figure 4.11a: Relative frequency distribution for\nTraditionalism Battery, item D, female respondents only")
q21.plot
...
q22.plot <- ggplot(q22.melt, aes(x=Attitude, y=RelFreq)) + 
  ...
  labs(x="\nSometimes one has to follow one's own beliefs regardless of what other people think.",
       y="Relative frequency", title="Figure 4.12a: Relative frequency distribution for\nTraditionalism Battery, item E, female respondents only")
q22.plot
...
q23.plot <- ggplot(q23.melt, aes(x=Attitude, y=RelFreq)) + 
  ...
  labs(x="\nOpen conflicts among politicians are harmful to society.",
       y="Relative frequency", title="Figure 4.13a: Relative frequency distribution for\nTraditionalism Battery, item F, female respondents only")
q23.plot
...
q24.plot <- ggplot(q24.melt, aes(x=Attitude, y=RelFreq)) + 
  ...
  labs(x="\nG.	People should always support the decisions\nof their government even if they disagree with them.",
       y="Relative frequency", title="Figure 4.14a: Relative frequency distribution for\nTraditionalism Battery, item G, female respondents only")
q24.plot
...
#quick cross gender analysis
t.test(male.c$Q18_Authority_parents, female.c$Q18_Authority_parents)
t.test(male.e$Q18_Authority_parents, female.e$Q18_Authority_parents)




t.test(male.c$Q19_Authority_teachers, female.c$Q19_Authority_teachers)
t.test(male.e$Q19_Authority_teachers, female.e$Q19_Authority_teachers)


t.test(male.c$Q20_Collective_neighbors_conflict, female.c$Q20_Collective_neighbors_conflict)
t.test(male.e$Q20_Collective_neighbors_conflict, female.e$Q20_Collective_neighbors_conflict)



t.test(male.c$Q21_Collective_family, female.c$Q21_Collective_family)
t.test(male.e$Q21_Collective_family, female.e$Q21_Collective_family)



t.test(male.c$Q22_Collective_unconformity, female.c$Q22_Collective_unconformity)
t.test(male.e$Q22_Collective_unconformity, female.e$Q22_Collective_unconformity)



t.test(male.c$Q23_Collective_leaders, female.c$Q23_Collective_leaders)
t.test(male.e$Q23_Collective_leaders, female.e$Q23_Collective_leaders)


t.test(male.c$Q24_Authority_government, female.c$Q24_Authority_government)
t.test(male.e$Q24_Authority_government, female.e$Q24_Authority_government)
